        ...
        <div class="box-container">
            ...
            ?>
                <div class="box">
                  ...
                  <p>name: <span><?php echo $fetch_orders['name'];?></span>
                 </p>
                 <p>number <span><?php echo $fetch_orders['number'];?></span></p>
                 <p>email: <span><?php echo $fetch_orders['email'];?></span></p>
                 <p>address: <span><?php echo $fetch_orders['address'];?></span></p>
                 <p>Total products: <span><?php echo $fetch_orders['total_products'];?></span>
                 </p>
                 <p>Total price <span>$<?php echo $fetch_orders['total_price'];?>/-</span>
                 </p>
                 <p>Payment status: <span><?php echo $fetch_orders['payment_status'];?></span>
                 </p>
                 <form action="" method="post">
                    ...
                    <a href="admin_orders.php?delete=<?php echo $fetch_orders['id'];?>" 
                     value='delete 'onclick="return confirm('delete this order?')" class="delete-btn">delete</a>
                 </form>
                </div>
             <?php
              }
